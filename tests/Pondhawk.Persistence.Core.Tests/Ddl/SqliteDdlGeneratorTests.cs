...
public class SqliteDdlGeneratorTests
{
    ...
    [Fact]
    public void GeneratesCreateView_NoSchemaQualifier()
    {
        var view = new Model
        {
            Name = "ActiveUsers", Schema = "main", IsView = true,
            SelectSql = "SELECT Id, Name FROM Users",
            Attributes = [new Attribute { Name = "Id", DataType = "INTEGER" }]
        };
        var ddl = _generator.Generate([view]);
        ddl.ShouldContain("CREATE VIEW \"ActiveUsers\" AS");
        ddl.ShouldNotContain("\"main\".");
